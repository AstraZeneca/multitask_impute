...
from datasets import create_separate_dataloader, create_separate_dataloader_cv
...
if __name__ == "__main__":
    ...
    # Get parameters
    param = TrainTestParams().parse() # to change learning rate, epochs, train test split etc. Also change other params here, as TrainTestParams is inherited from BasicParams
    if param.deterministic:
        util.setup_seed(param.seed)

    # Dataset related
    full_dataloader, train_dataloader, val_dataloader, test_dataloader = create_separate_dataloader_cv(param)
